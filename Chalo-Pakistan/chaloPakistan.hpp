...
public: 
    ...
    // Existing console-driven methods
    ...
    // *** NEW: for SFML screens ***
    void setTransport(Transport* t, int scheduleChoice);
    void setPackage(Packages* p);
